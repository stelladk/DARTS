...
class Logger:
    ...
    def start_run(self, run_name: str | None = None, **kwargs) -> None:
        ...
        run_name : str, optional
            name for the run, by default None (auto-generated by the backend)
        """
        if not self.enabled:
            return
        if self.api == "mlflow":
        ...
        if self.api == "wandb":
            self.__start_wandb_run(name=run_name, **kwargs)
    ...
    def __start_mlflow_run(self, tags: dict | None = None, run_name: str | None = None, **kwargs) -> None:
        mlflow.start_run(log_system_metrics=True, tags=tags, run_name=run_name, **kwargs)
    ...
    def __start_wandb_run(self, tags: dict = {}, name: str | None = None, **kwargs) -> None:
